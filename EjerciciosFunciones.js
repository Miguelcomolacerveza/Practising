...
let numeroUsuario = convertirCadenaNumero(prompt("Inserta un número"));
...
console.log("La suma total de los números es " + sumaTotalSumaPares);
...
let baseTriangulo = convertirCadenaNumero(prompt("Inserta la base"));
let alturaTriangulo = convertirCadenaNumero(prompt("Inserta la altura"));
...
let numeroFactorialUsuario = convertirCadenaNumero(prompt("Inserta un número"));

/* Llamo a la función que calcula el factorial del numero insertado
 y muestro el resultado por pantalla */

 let factorialTotal = factorial(numeroFactorialUsuario);
 console.log("El factorial del numero es: " + factorialTotal);